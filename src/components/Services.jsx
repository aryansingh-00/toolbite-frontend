      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="relative w-full group/slider">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 z-20 hidden md:block opacity-0 group-hover/slider:opacity-100 transition-opacity duration-300">
            <button title="Interactive Button" aria-label="Interactive Button" onClick={() => scroll('right')} title="Scroll Right" aria-label="Scroll Right" className="w-14 h-14 rounded-full bg-slate-900 border border-slate-900 flex items-center justify-center text-white hover:bg-[#B19CD9] hover:border-[#B19CD9] transition-all shadow-xl shadow-[#B19CD9]/20 hover:scale-110">
