    ...
    <section id="contact" className="py-24 bg-white relative">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 lg:hidden">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-black mb-6 tracking-tight">Let's Build Something Great</h3>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="hidden lg:block mb-12">
              <h2 className="text-teal-600 font-semibold tracking-wide uppercase text-sm mb-3">Get In Touch</h2>
              <h3 className="text-4xl lg:text-5xl font-bold text-black mb-6 leading-tight tracking-tight">Ready to scale your<br/>digital presence?</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-emerald-100 transition-all duration-300">
                ...
                <h4 className="text-lg font-bold text-black mb-1">WhatsApp / Call</h4>
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-blue-100 transition-all duration-300">
                ...
                <h4 className="text-lg font-bold text-black mb-1">HQ Office</h4>
                <p className="text-sm text-slate-500 mb-2">Come say hello</p>
                <span className="text-black font-medium leading-tight block">New Delhi,<br/>India</span>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-purple-100 transition-all duration-300">
                ...
                <h4 className="text-lg font-bold text-black mb-1">Business Hours</h4>
                <p className="text-sm text-slate-500 mb-2">We are open</p>
                <span className="text-black font-medium leading-tight block">Monday - Friday<br/>9:00 AM - 6:00 PM EST</span>
              </div>
            </div>

            {/* Social Links */}
            <div>
              <h4 className="text-sm font-bold text-black uppercase tracking-widest mb-4">Connect with us</h4>
              <div className="flex gap-3">
                <a href="https://www.threads.com/@hello.toolbite" className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center text-black border border-slate-100 hover:bg-slate-900 hover:text-white hover:border-slate-900 transition-all shadow-sm">
                  <Twitter size={20} />
                </a>
                ...
                <a href="https://github.com/aryansingh-00" className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center text-black border border-slate-100 hover:bg-slate-900 hover:text-white hover:border-slate-900 transition-all shadow-sm">
                  <Github size={20} />
                </a>
                <a href="https://www.youtube.com/@tool-bite" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center text-black border border-slate-100 hover:bg-red-600 hover:text-white hover:border-red-600 transition-all shadow-sm" aria-label="YouTube">
                  <Youtube size={20} />
                </a>
              </div>
            </div>
          ...
          >
            ...
            {status === 'sent' ? (
              <div className="py-16 text-center">
                ...
                <p className="text-black mb-8">We'll get back to you as soon as possible.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input name="name" required type="text" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:bg-white transition-all text-black" placeholder="John Doe" />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-black mb-2">Email Address</label>
                    <input name="email" required type="email" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:bg-white transition-all text-black" placeholder="john@example.com" />
                  </div>
                </div>
                
                <div>
                  <label className="block text-sm font-bold text-black mb-2">Subject</label>
                  <select name="subject" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:bg-white transition-all text-black appearance-none font-medium">
                ...
                <div>
                  <label className="block text-sm font-bold text-black mb-2">How can we help?</label>
                  <textarea name="message" required rows="4" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:bg-white transition-all resize-none text-black" placeholder="Tell us about your project..."></textarea>
                </div>
