...
export const whyChooseUsData = [
  { icon: <Zap size={24} className="text-amber-500" />, title: 'Rapid Deployment Dynamics', desc: 'We leverage advanced modular architecture to deploy enterprise-grade platforms in days, bypassing traditional sluggish agency timelines.', bg: 'bg-amber-50', border: 'border-amber-100' },
  { icon: <Palette size={24} className="text-rose-500" />, title: 'Elite UI/UX Engineering', desc: 'Aesthetics drive credibility. We strictly adhere to modern psychological design principles to guarantee your interface commands absolute market respect.', bg: 'bg-rose-50', border: 'border-rose-100' },
  { icon: <Smartphone size={24} className="text-blue-500" />, title: 'Omnichannel Flawless Code', desc: 'Our rigorous QA protocol ensures zero layout shifts and absolute pixel perfection across every mobile device and ultrawide monitor matrix.', bg: 'bg-blue-50', border: 'border-blue-100' },
  { icon: <DollarSign size={24} className="text-emerald-500" />, title: 'Transparent Cost Modeling', desc: 'Premium engineering shouldn’t possess hidden traps. We provide aggressive, fixed-cost pricing structures with zero scope creep anxiety.', bg: 'bg-emerald-50', border: 'border-emerald-100' },
  { icon: <Search size={24} className="text-teal-500" />, title: 'Deep Technical SEO', desc: 'Every line of code is semantically structured and statically optimized to instantly pass Google Core Web Vitals and dominate SERP rankings.', bg: 'bg-teal-50', border: 'border-teal-100' },
  { icon: <MessageSquare size={24} className="text-indigo-500" />, title: 'Direct Developer Access', desc: 'We abhor bureaucratic barriers. You work directly alongside the senior software engineers actually architecting your platform.', bg: 'bg-indigo-50', border: 'border-indigo-100' },
  { icon: <Wrench size={24} className="text-orange-500" />, title: 'Infinite Scalability', desc: 'We do not build fragile websites. We engineer scalable technological foundations ready to expand gracefully as your userbase skyrockets.', bg: 'bg-orange-50', border: 'border-orange-100' },
  { icon: <ShieldCheck size={24} className="text-cyan-500" />, title: 'Enterprise Defensive Security', desc: 'Your platform is hardened against vulnerabilities. We deploy continuous threat monitoring, automated backups, and encrypted transit pathways.', bg: 'bg-cyan-50', border: 'border-cyan-100' },
  { icon: <MousePointerClick size={24} className="text-purple-500" />, title: 'Psychological User Flows', desc: 'Every hovering micro-animation and padding variance is intentionally programmed to seamlessly guide human psychology toward conversion.', bg: 'bg-purple-50', border: 'border-purple-100' },
  { icon: <Briefcase size={24} className="text-slate-700" />, title: 'Strict ROI Fixation', desc: 'Code is merely a tool. Our ultimate objective is engineering a digital asset that drastically multiplies your commercial revenue metrics.', bg: 'bg-slate-100', border: 'border-slate-200' }
];
