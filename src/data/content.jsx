...
export const servicesData = [
  { 
    ...
    seoTitle: 'Mobile App Development Agency for iOS & Android | ToolBite',
    description: 'Turn your app idea into reality with ToolBite\'s expert mobile app development services. High-performance iOS and Android apps. Contact us now!', 
  ...
  { 
    ...
    seoTitle: 'Custom Web Development Services & Solutions | ToolBite',
    description: 'Transform your online presence with custom web development services from ToolBite. We build scalable, high-performing websites. Get a free quote!', 
  ...
  { icon: <Code2 className="w-6 h-6 text-indigo-500" />, title: 'Custom SaaS Architecture', slug: 'saas-development', seoTitle: 'Custom SaaS Product Development & Engineering | ToolBite', description: 'Scale your business with robust, cloud-ready SaaS development services by ToolBite. From MVP to enterprise, we engineer success. Learn more!', bg: 'bg-indigo-50', border: 'border-indigo-200' },
