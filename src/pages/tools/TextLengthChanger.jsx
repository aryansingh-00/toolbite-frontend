    ...
    <ToolLayout
      ...
      extendedContent={
        <div className="space-y-12">
          <section>
            <h2 className="text-3xl font-black text-black mb-6">The Art of Information Density</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <section>
              <h3 className="text-xl font-bold text-black mb-4">The Need to Summarize</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-black mb-4">The Need to Expand</h3>
              <p className="text-black leading-relaxed italic mb-4">
          ...
          <section className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
            <h3 className="text-xl font-bold text-black mb-4">How AI Alters Content Volume</h3>
        ...
        <div className="bg-white rounded-[2rem] p-8 md:p-10 border border-slate-100 shadow-xl shadow-slate-200/40">
          <div className="flex flex-col md:flex-row gap-8 mb-8">
            ...
            <div className="w-full md:w-64 space-y-4">
              <label className="text-sm font-bold text-black block text-center mb-4">Select Target</label>
        ...
        {result && (
          <div className="relative group animate-in slide-in-from-top-4 duration-500">
            <div className={`p-8 rounded-[2rem] border-2 shadow-lg ${target === 'Summarize' ? 'bg-amber-50 border-amber-200' : 'bg-indigo-50 border-indigo-200'}`}>
              ...
              <p className="text-black font-medium leading-relaxed whitespace-pre-line mb-6">
                {result}
              </p>
              <button title="Interactive Button" aria-label="Interactive Button" 
                onClick={handleCopy}
