    ...
    <ToolLayout
      ...
      extendedContent={
        <div className="space-y-12">
          <section>
            <h2 className="text-3xl font-black text-black mb-6">The Science of Synthetic Speech</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <section>
              <h3 className="text-xl font-bold text-black mb-4">Accessibility & Inclusivity</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-black mb-4">Audio UX for Content Creators</h3>
          ...
          <section className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
            <h3 className="text-xl font-bold text-black mb-4">Why Local Processing?</h3>
            <p className="text-black leading-relaxed">
      ...
      <div className="space-y-10">
        <div className="relative">
          <textarea
            ...
            className="w-full h-80 p-8 rounded-3xl bg-slate-50 border-2 border-slate-100 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all font-medium text-black resize-none text-xl leading-relaxed shadow-sm"
          />
