    ...
    <ToolLayout
      ...
      extendedContent={
        <div className="space-y-12">
          <section>
            <h2 className="text-3xl font-black text-black mb-6">The Legacy of Dummy Text in Design</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <section>
              <h3 className="text-xl font-bold text-black mb-4">Why "Real" Content Ruins Prototypes</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-black mb-4">Precision Formatting for Modern UI/UX</h3>
              <p className="text-black leading-relaxed mb-4">
          ...
          <section className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
            <h3 className="text-xl font-bold text-black mb-4">SEO and Placeholder Risks</h3>
    ...
    >
      <div className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-slate-50 rounded-2xl border border-slate-100">
          ...
          <div className="flex flex-col justify-end">
            <button title="Interactive Button" aria-label="Interactive Button" 
              ...
              className={`flex items-center justify-between px-6 py-4 rounded-xl font-bold transition-all ${startWithLorem ? 'bg-teal-600 text-white' : 'bg-white border border-slate-200 text-black'}`}
            >
        ...
        <div className="relative group">
          <div className="w-full min-h-[320px] p-8 rounded-2xl bg-white border border-slate-200 text-black leading-relaxed font-medium overflow-auto">
            {generatedText.split('\n\n').map((p, i) => (
