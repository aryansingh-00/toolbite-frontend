    ...
    <ToolLayout
      ...
      extendedContent={
        <div className="space-y-12">
          <section>
            <h2 className="text-3xl font-black text-black mb-6">Understanding JSON Architecture</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <section>
              <h3 className="text-xl font-bold text-black mb-4">Why Formatting Matters for Debugging</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-black mb-4">Common JSON Syntax Errors</h3>
          ...
          <section className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
            <h3 className="text-xl font-bold text-black mb-4">The Logic Behind Minification</h3>
