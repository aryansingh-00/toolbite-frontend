    ...
    <ToolLayout
      ...
      extendedContent={
        <div className="space-y-12">
          <section>
            <h2 className="text-3xl font-black text-black mb-6">Why Markdown is the Industry Standard</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <section>
              <h3 className="text-xl font-bold text-black mb-4">GFM Support</h3>
            ...
            <section className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
              <h3 className="text-xl font-bold text-black mb-4">Developer Workflow</h3>
              <p className="text-black leading-relaxed">
        ...
        <div className="flex flex-col bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-black text-sm uppercase tracking-widest">Markdown Editor</span>
            </div>
          ...
          <textarea
            ...
            className="flex-grow p-6 font-mono text-sm focus:outline-none resize-none bg-white text-black leading-relaxed"
        ...
        <div className="flex flex-col bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-black text-sm uppercase tracking-widest">Live Preview</span>
            </div>
          ...
          <div className="flex-grow p-8 overflow-y-auto prose prose-slate max-w-none prose-headings:text-black prose-headings:font-black prose-a:text-teal-600 prose-code:text-teal-600 prose-pre:bg-slate-900 prose-pre:text-white">
